...
export const tablename = "five_s_actions";
...
export const T_FiveSActions = pgTable(tablename, columns, indexes);

export function createTableForSchema(schema: ReturnType<typeof pgSchema>) {
    return schema.table(tablename, columns, indexes);
}

export type FiveSAction = InferSelectModel<typeof T_FiveSActions>;
export type FiveSActionJSON = InferSerializedSelectModel<typeof T_FiveSActions>;

export type Create = Omit<FiveSAction, DefaultOmitted>;
...
export type ListReturn = {
    data: FiveSActionJSON[];
    pagination: Pagination;
};

export const store: FiveSActionJSON | undefined = undefined;

export const SearchConfig: HybridSearchConfig =
    createHybridSearchConfigFromColumns("T_FiveSActions", columns, {
        relations: [],
        fieldSelection: {},
